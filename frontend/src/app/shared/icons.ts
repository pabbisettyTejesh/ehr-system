/**
 * A single, consistent icon set for the whole app, sourced from the official
 * Lucide icon library (ISC license, https://lucide.dev) so every portal uses
 * the same stroke weight, corner radius and proportions.
 *
 * Usage: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
 *          stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
 *          [innerHTML]="icons.calendar"></svg>
 */
